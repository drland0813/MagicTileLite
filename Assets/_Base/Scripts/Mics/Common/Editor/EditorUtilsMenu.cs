...
namespace Common.Editor
{
    ...
    {
        [MenuItem("Personal/Utils/Data/Clear Player Pref", false, 20)]
        ...
        [MenuItem("Personal/Utils/Data/Clear Persistant Data", false, 20)]
        ...
        [MenuItem("Personal/Utils/Data/Clear temporary Data", false, 20)]
        ...
        [MenuItem("Personal/Utils/Data/Clear All", false, 12)]
        ...
        [MenuItem("Personal/Utils/Memory/UnloadAllUnusedAssets", false, 20)]
        ...
        [MenuItem("Personal/Utils/Setup Boostrap Scene", false, 30)]
        public static void SetupBootstrapScene()
        {
            ...
            //Create GameFlow GameObject
            var gameFlow = new GameObject("GameFlow", typeof(GameFlow)).GetComponent<GameFlow>();
        }
    }
}